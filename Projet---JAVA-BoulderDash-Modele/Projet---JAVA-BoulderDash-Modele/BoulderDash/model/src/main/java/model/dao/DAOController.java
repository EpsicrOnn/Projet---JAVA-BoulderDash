...
final class DAOController {
	...
	/** The url. */
	private static String url = "jdbc:mysql://localhost/boulderdashgame?useSSL=false&serverTimezone=UTC";
	 ...
	 *            the new instance
	 */
	private static void setInstance(final DAOController instance) {
		DAOController.instance = instance;
	}
	...
	boolean open() {
		try {
			this.connection = DriverManager.getConnection(DAOController.url, DAOController.user,
					DAOController.password);
