...
public class BoardFrame extends JFrame implements IBoard {
	 ...
	 * @param string
	 */
	public BoardFrame(final String string, final EventPerformer eventPerformer, final GraphicsBuilder graphicsBuilder,
	 ...
	 */
	@Override
	public final void addSquare(final IElement iElement, final int x, final int y) {
		this.getBoardPanel().addSquare(iElement, x, y);
	}
	 ...
	 */
	@Override
	public final void addPawn(final IMobile element) {
		this.getBoardPanel().addPawn(element);
	}
